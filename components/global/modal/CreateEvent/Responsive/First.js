...
import GlobalCreateEventResponsiveSecond from "./Second";
...
const GlobalCreateEventResponsiveFirst = (props) => {
  ...
  useEffect(() => {
    firestore
      ...
      .get()
      .then((doc) => {
        setEventId(doc.data().eventIdInitializer);
      });
    setThumbnailURL(
      ...
      {user && modal === false ? (
        <Box align={"center"} w={"100%"}>
          <Box align={"left"} mt={"10px"} w={"80%"}>
            ...
            >
              <Box align={"center"} my={"10px"} w={"100%"}>
        ...
        <GlobalCreateEventResponsiveSecond
...
export default GlobalCreateEventResponsiveFirst;
